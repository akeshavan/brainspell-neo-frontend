export default [
  ...
  { name: 'Taste Aversion' },
  { name: 'Valence' },
  { superClass: '1', name: 'Executive-Cognitive Control' },
  ...
  { superClass: '1', name: 'Learning And Memory' },
  { name: 'Active Recall' },
  ...
  { superClass: '1', name: 'Reasoning And Decision Making' },
  ...
  { name: 'Uncertainty' },
  { name: 'Utility' },
  { superClass: '1', name: 'Social Function' },
  { name: 'Attachment' },
  { name: 'Communication' },
  { name: 'Deception' },
